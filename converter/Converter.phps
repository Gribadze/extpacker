...
class Converter
{
    ...
    public function copyRenamedImages()
    {
        ...
        $target = 'resources/outputs/' . $this->basename . '/start/skin/images';
    ...
    public function convertScreenshots($size)
    {
        ...
        $target = sprintf(
            'resources/outputs/%s/start/skin/screenshots_%s', $this->basename, $size
        );
    ...
    public function convertIcons($formats, $source = '256x256')
    {
        ...
        foreach ($formats as $format) {
            ...
            imagepng($icon, sprintf(
                'resources/outputs/%s/start/skin/icons/%s.png', $this->basename, $dst_w
            ));
        ...
        file_put_contents(sprintf(
            'resources/outputs/%s/start/skin/icons/%s.png', $this->basename, $src_w
        ), $contents);
